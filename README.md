...
## Goal
The following project has the aim to predict if a web traffic access to a website is an DDoS attack or a normal user. Also, we used different appraoches to handle this large dataset in a more efficient way.
